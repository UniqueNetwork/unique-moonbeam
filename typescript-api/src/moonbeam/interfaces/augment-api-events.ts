...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      ForeignAssetDestroyed: AugmentedEvent<ApiType, [assetId: u128, assetType: MoonbeamRuntimeXcmConfigAssetType], { assetId: u128, assetType: MoonbeamRuntimeXcmConfigAssetType }>;
      /**
       * New asset with the asset manager is registered
       **/
      ForeignAssetRegistered: AugmentedEvent<ApiType, [assetId: u128, asset: MoonbeamRuntimeXcmConfigAssetType, metadata: MoonbeamRuntimeAssetConfigAssetRegistrarMetadata], { assetId: u128, asset: MoonbeamRuntimeXcmConfigAssetType, metadata: MoonbeamRuntimeAssetConfigAssetRegistrarMetadata }>;
      /**
       * Removed all information related to an assetId
       **/
      ForeignAssetRemoved: AugmentedEvent<ApiType, [assetId: u128, assetType: MoonbeamRuntimeXcmConfigAssetType], { assetId: u128, assetType: MoonbeamRuntimeXcmConfigAssetType }>;
      /**
       * Changed the xcm type mapping for a given asset id
       **/
      ForeignAssetXcmLocationChanged: AugmentedEvent<ApiType, [assetId: u128, newAssetType: MoonbeamRuntimeXcmConfigAssetType], { assetId: u128, newAssetType: MoonbeamRuntimeXcmConfigAssetType }>;
      /**
       * Removed all information related to an assetId and destroyed asset
       **/
       ...
       **/
      SupportedAssetRemoved: AugmentedEvent<ApiType, [assetType: MoonbeamRuntimeXcmConfigAssetType], { assetType: MoonbeamRuntimeXcmConfigAssetType }>;
      /**
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId20, delegatee: AccountId20, proxyType: MoonbeamRuntimeProxyType, delay: u32], { delegator: AccountId20, delegatee: AccountId20, proxyType: MoonbeamRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId20, delegatee: AccountId20, proxyType: MoonbeamRuntimeProxyType, delay: u32], { delegator: AccountId20, delegatee: AccountId20, proxyType: MoonbeamRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId20, who: AccountId20, proxyType: MoonbeamRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId20, who: AccountId20, proxyType: MoonbeamRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
