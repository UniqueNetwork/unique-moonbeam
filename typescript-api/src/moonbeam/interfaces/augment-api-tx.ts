...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * assetType
       **/
      changeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: MoonbeamRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, MoonbeamRuntimeXcmConfigAssetType, u32]>;
      /**
       ...
       **/
      registerForeignAsset: AugmentedSubmittable<(asset: MoonbeamRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonbeamRuntimeAssetConfigAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array, isSufficient: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeXcmConfigAssetType, MoonbeamRuntimeAssetConfigAssetRegistrarMetadata, u128, bool]>;
      /**
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: MoonbeamRuntimeRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | { PalletRandomness: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proxy: {
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | Uint8Array | MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | Uint8Array | MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
       ...
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbeamRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonbeamRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { Origins: any } | { TreasuryCouncilCollective: any } | { OpenTechCommitteeCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
