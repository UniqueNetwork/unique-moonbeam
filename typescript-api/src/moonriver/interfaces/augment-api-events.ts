...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      ForeignAssetDestroyed: AugmentedEvent<ApiType, [assetId: u128, assetType: MoonriverRuntimeXcmConfigAssetType], { assetId: u128, assetType: MoonriverRuntimeXcmConfigAssetType }>;
      /**
       * New asset with the asset manager is registered
       **/
      ForeignAssetRegistered: AugmentedEvent<ApiType, [assetId: u128, asset: MoonriverRuntimeXcmConfigAssetType, metadata: MoonriverRuntimeAssetConfigAssetRegistrarMetadata], { assetId: u128, asset: MoonriverRuntimeXcmConfigAssetType, metadata: MoonriverRuntimeAssetConfigAssetRegistrarMetadata }>;
      /**
       * Removed all information related to an assetId
       **/
      ForeignAssetRemoved: AugmentedEvent<ApiType, [assetId: u128, assetType: MoonriverRuntimeXcmConfigAssetType], { assetId: u128, assetType: MoonriverRuntimeXcmConfigAssetType }>;
      /**
       * Changed the xcm type mapping for a given asset id
       **/
      ForeignAssetXcmLocationChanged: AugmentedEvent<ApiType, [assetId: u128, newAssetType: MoonriverRuntimeXcmConfigAssetType], { assetId: u128, newAssetType: MoonriverRuntimeXcmConfigAssetType }>;
      /**
       * Removed all information related to an assetId and destroyed asset
       **/
       ...
       **/
      SupportedAssetRemoved: AugmentedEvent<ApiType, [assetType: MoonriverRuntimeXcmConfigAssetType], { assetType: MoonriverRuntimeXcmConfigAssetType }>;
      /**
    ...
    evmForeignAssets: {
       ...
       * New asset with the asset manager is registered
       **/
      ForeignAssetCreated: AugmentedEvent<ApiType, [contractAddress: H160, assetId: u128, xcmLocation: StagingXcmV4Location], { contractAddress: H160, assetId: u128, xcmLocation: StagingXcmV4Location }>;
      ForeignAssetFrozen: AugmentedEvent<ApiType, [assetId: u128, xcmLocation: StagingXcmV4Location], { assetId: u128, xcmLocation: StagingXcmV4Location }>;
      ForeignAssetUnfrozen: AugmentedEvent<ApiType, [assetId: u128, xcmLocation: StagingXcmV4Location], { assetId: u128, xcmLocation: StagingXcmV4Location }>;
      /**
       * Changed the xcm type mapping for a given asset id
       **/
      ForeignAssetXcmLocationChanged: AugmentedEvent<ApiType, [assetId: u128, newXcmLocation: StagingXcmV4Location], { assetId: u128, newXcmLocation: StagingXcmV4Location }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    parameters: {
       ...
       **/
      Updated: AugmentedEvent<ApiType, [key: MoonriverRuntimeRuntimeParamsRuntimeParametersKey, oldValue: Option<MoonriverRuntimeRuntimeParamsRuntimeParametersValue>, newValue: Option<MoonriverRuntimeRuntimeParamsRuntimeParametersValue>], { key: MoonriverRuntimeRuntimeParamsRuntimeParametersKey, oldValue: Option<MoonriverRuntimeRuntimeParamsRuntimeParametersValue>, newValue: Option<MoonriverRuntimeRuntimeParamsRuntimeParametersValue> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId20, delegatee: AccountId20, proxyType: MoonriverRuntimeProxyType, delay: u32], { delegator: AccountId20, delegatee: AccountId20, proxyType: MoonriverRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId20, delegatee: AccountId20, proxyType: MoonriverRuntimeProxyType, delay: u32], { delegator: AccountId20, delegatee: AccountId20, proxyType: MoonriverRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId20, who: AccountId20, proxyType: MoonriverRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId20, who: AccountId20, proxyType: MoonriverRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    treasury: {
       ...
       **/
      AssetSpendApproved: AugmentedEvent<ApiType, [index: u32, assetKind: Null, amount: u128, beneficiary: AccountId20, validFrom: u32, expireAt: u32], { index: u32, assetKind: Null, amount: u128, beneficiary: AccountId20, validFrom: u32, expireAt: u32 }>;
      /**
    ...
    xcmTransactor: {
       ...
       **/
      DestFeePerSecondChanged: AugmentedEvent<ApiType, [location: StagingXcmV4Location, feePerSecond: u128], { location: StagingXcmV4Location, feePerSecond: u128 }>;
      /**
       * Remove dest fee per second
       **/
      DestFeePerSecondRemoved: AugmentedEvent<ApiType, [location: StagingXcmV4Location], { location: StagingXcmV4Location }>;
      /**
       ...
       **/
      TransactedDerivative: AugmentedEvent<ApiType, [accountId: AccountId20, dest: StagingXcmV4Location, call: Bytes, index: u16], { accountId: AccountId20, dest: StagingXcmV4Location, call: Bytes, index: u16 }>;
      /**
       * Transacted the call through a signed account in a destination chain.
       **/
      TransactedSigned: AugmentedEvent<ApiType, [feePayer: AccountId20, dest: StagingXcmV4Location, call: Bytes], { feePayer: AccountId20, dest: StagingXcmV4Location, call: Bytes }>;
      /**
       * Transacted the call through the sovereign account in a destination chain.
       **/
      TransactedSovereign: AugmentedEvent<ApiType, [feePayer: Option<AccountId20>, dest: StagingXcmV4Location, call: Bytes], { feePayer: Option<AccountId20>, dest: StagingXcmV4Location, call: Bytes }>;
      /**
       * Transact failed
       **/
      TransactFailed: AugmentedEvent<ApiType, [error: XcmV3TraitsError], { error: XcmV3TraitsError }>;
      /**
       * Changed the transact info of a location
       **/
      TransactInfoChanged: AugmentedEvent<ApiType, [location: StagingXcmV4Location, remoteInfo: PalletXcmTransactorRemoteTransactInfoWithMaxWeight], { location: StagingXcmV4Location, remoteInfo: PalletXcmTransactorRemoteTransactInfoWithMaxWeight }>;
      /**
       * Removed the transact info of a location
       **/
      TransactInfoRemoved: AugmentedEvent<ApiType, [location: StagingXcmV4Location], { location: StagingXcmV4Location }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xcmWeightTrader: {
       ...
       **/
      PauseAssetSupport: AugmentedEvent<ApiType, [location: StagingXcmV4Location], { location: StagingXcmV4Location }>;
      /**
       * Resume support for a given asset
       **/
      ResumeAssetSupport: AugmentedEvent<ApiType, [location: StagingXcmV4Location], { location: StagingXcmV4Location }>;
      /**
       * New supported asset is registered
       **/
      SupportedAssetAdded: AugmentedEvent<ApiType, [location: StagingXcmV4Location, relativePrice: u128], { location: StagingXcmV4Location, relativePrice: u128 }>;
      /**
       * Changed the amount of units we are charging per execution second for a given asset
       **/
      SupportedAssetEdited: AugmentedEvent<ApiType, [location: StagingXcmV4Location, relativePrice: u128], { location: StagingXcmV4Location, relativePrice: u128 }>;
      /**
       * Supported asset type for fee payment removed
       **/
      SupportedAssetRemoved: AugmentedEvent<ApiType, [location: StagingXcmV4Location], { location: StagingXcmV4Location }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
