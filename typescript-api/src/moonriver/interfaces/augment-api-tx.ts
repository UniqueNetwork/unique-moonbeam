...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * assetType
       **/
      changeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, MoonriverRuntimeXcmConfigAssetType, u32]>;
      /**
       ...
       * data
       **/
      destroyForeignAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, u32]>;
      /**
       * Register new asset with the asset manager
       **/
      registerForeignAsset: AugmentedSubmittable<(asset: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonriverRuntimeAssetConfigAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array, isSufficient: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeXcmConfigAssetType, MoonriverRuntimeAssetConfigAssetRegistrarMetadata, u128, bool]>;
      /**
       * Remove a given assetId -> assetType association
       **/
      removeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, u32]>;
      /**
       * Generic tx
       **/
    ...
    assets: {
       ...
       * Weight: `O(1)`
       **/
      approveTransfer: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, delegate: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, Compact<u128>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      block: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       **/
      burn: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, Compact<u128>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      cancelApproval: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, delegate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      create: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, admin: AccountId20 | string | Uint8Array, minBalance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, u128]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      forceCancelApproval: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, owner: AccountId20 | string | Uint8Array, delegate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, AccountId20]>;
      /**
       * Clear the metadata for an asset.
       * 
       * Origin must be ForceOrigin.
       ...
       * Weight: `O(1)`
       **/
      forceCreate: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, owner: AccountId20 | string | Uint8Array, isSufficient: bool | boolean | Uint8Array, minBalance: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, bool, Compact<u128>]>;
      /**
       ...
       * `dest`.
       **/
      forceTransfer: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, source: AccountId20 | string | Uint8Array, dest: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, AccountId20, Compact<u128>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      freeze: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       **/
      mint: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, beneficiary: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, Compact<u128>]>;
      /**
       ...
       * Emits `Refunded` event when successful.
       **/
      refundOther: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      setTeam: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, issuer: AccountId20 | string | Uint8Array, admin: AccountId20 | string | Uint8Array, freezer: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, AccountId20, AccountId20]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      thaw: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       * Emits `Touched` event when successful.
       **/
      touchOther: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, who: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       ...
       * `target`.
       **/
      transfer: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, target: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, Compact<u128>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      transferApproved: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, owner: AccountId20 | string | Uint8Array, destination: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, AccountId20, Compact<u128>]>;
      /**
       ...
       * `target`.
       **/
      transferKeepAlive: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, target: AccountId20 | string | Uint8Array, amount: Compact<u128> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20, Compact<u128>]>;
      /**
       ...
       * Weight: `O(1)`
       **/
      transferOwnership: AugmentedSubmittable<(id: Compact<u128> | AnyNumber | Uint8Array, owner: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    convictionVoting: {
       ...
       **/
      delegate: AugmentedSubmittable<(clazz: u16 | AnyNumber | Uint8Array, to: AccountId20 | string | Uint8Array, conviction: PalletConvictionVotingConviction | 'None' | 'Locked1x' | 'Locked2x' | 'Locked3x' | 'Locked4x' | 'Locked5x' | 'Locked6x' | number | Uint8Array, balance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, AccountId20, PalletConvictionVotingConviction, u128]>;
      /**
       ...
       **/
      removeOtherVote: AugmentedSubmittable<(target: AccountId20 | string | Uint8Array, clazz: u16 | AnyNumber | Uint8Array, index: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u16, u32]>;
      /**
       * Remove a vote for a poll.
       * 
       * If:
       ...
       **/
      unlock: AugmentedSubmittable<(clazz: u16 | AnyNumber | Uint8Array, target: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16, AccountId20]>;
      /**
    ...
    crowdloanRewards: {
       ...
       **/
      associateNativeIdentity: AugmentedSubmittable<(rewardAccount: AccountId20 | string | Uint8Array, relayAccount: U8aFixed | string | Uint8Array, proof: SpRuntimeMultiSignature | { Ed25519: any } | { Sr25519: any } | { Ecdsa: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, U8aFixed, SpRuntimeMultiSignature]>;
      /**
       ...
       **/
      changeAssociationWithRelayKeys: AugmentedSubmittable<(rewardAccount: AccountId20 | string | Uint8Array, previousAccount: AccountId20 | string | Uint8Array, proofs: Vec<ITuple<[U8aFixed, SpRuntimeMultiSignature]>> | ([U8aFixed | string | Uint8Array, SpRuntimeMultiSignature | { Ed25519: any } | { Sr25519: any } | { Ecdsa: any } | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Vec<ITuple<[U8aFixed, SpRuntimeMultiSignature]>>]>;
      /**
       ...
       **/
      initializeRewardVec: AugmentedSubmittable<(rewards: Vec<ITuple<[U8aFixed, Option<AccountId20>, u128]>> | ([U8aFixed | string | Uint8Array, Option<AccountId20> | null | Uint8Array | AccountId20 | string, u128 | AnyNumber | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[U8aFixed, Option<AccountId20>, u128]>>]>;
      /**
       * Update reward address, proving that the caller owns the current native key
       **/
      updateRewardAddress: AugmentedSubmittable<(newRewardAccount: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    emergencyParaXcm: {
       ...
       **/
      fastAuthorizeUpgrade: AugmentedSubmittable<(codeHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H256]>;
      /**
       * Resume `Normal` mode
       **/
    ...
    ethereumXcm: {
       ...
       **/
      forceTransactAs: AugmentedSubmittable<(transactAs: H160 | string | Uint8Array, xcmTransaction: XcmPrimitivesEthereumXcmEthereumXcmTransaction | { V1: any } | { V2: any } | string | Uint8Array, forceCreateAddress: Option<H160> | null | Uint8Array | H160 | string) => SubmittableExtrinsic<ApiType>, [H160, XcmPrimitivesEthereumXcmEthereumXcmTransaction, Option<H160>]>;
      /**
       ...
       **/
      transact: AugmentedSubmittable<(xcmTransaction: XcmPrimitivesEthereumXcmEthereumXcmTransaction | { V1: any } | { V2: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmPrimitivesEthereumXcmEthereumXcmTransaction]>;
      /**
       * Xcm Transact an Ethereum transaction through proxy.
       * Weight: Gas limit plus the db reads involving the suspension and proxy checks
       **/
      transactThroughProxy: AugmentedSubmittable<(transactAs: H160 | string | Uint8Array, xcmTransaction: XcmPrimitivesEthereumXcmEthereumXcmTransaction | { V1: any } | { V2: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H160, XcmPrimitivesEthereumXcmEthereumXcmTransaction]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    evmForeignAssets: {
       ...
       * assetType
       **/
      changeXcmLocation: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newXcmLocation: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, StagingXcmV4Location]>;
      /**
       * Create new asset with the ForeignAssetCreator
       **/
      createForeignAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, xcmLocation: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array, decimals: u8 | AnyNumber | Uint8Array, symbol: Bytes | string | Uint8Array, name: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, StagingXcmV4Location, u8, Bytes, Bytes]>;
      /**
       * Freeze a given foreign assetId
       **/
      freezeForeignAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, allowXcmDeposit: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, bool]>;
      /**
       * Unfreeze a given foreign assetId
       **/
      unfreezeForeignAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    identity: {
       ...
       **/
      addUsernameAuthority: AugmentedSubmittable<(authority: AccountId20 | string | Uint8Array, suffix: Bytes | string | Uint8Array, allocation: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Bytes, u32]>;
      /**
       ...
       **/
      removeUsernameAuthority: AugmentedSubmittable<(authority: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       ...
       * `MaxUsernameLength`.
       **/
      setUsernameFor: AugmentedSubmittable<(who: AccountId20 | string | Uint8Array, username: Bytes | string | Uint8Array, signature: Option<AccountEthereumSignature> | null | Uint8Array | AccountEthereumSignature | string) => SubmittableExtrinsic<ApiType>, [AccountId20, Bytes, Option<AccountEthereumSignature>]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    moonbeamLazyMigrations: {
      clearSuicidedStorage: AugmentedSubmittable<(addresses: Vec<H160> | (H160 | string | Uint8Array)[], limit: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<H160>, u32]>;
      createContractMetadata: AugmentedSubmittable<(address: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H160]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    moonbeamOrbiters: {
       ...
       **/
      addCollator: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Add an orbiter in a collator pool
       **/
      collatorAddOrbiter: AugmentedSubmittable<(orbiter: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Remove an orbiter from the caller collator pool
       **/
      collatorRemoveOrbiter: AugmentedSubmittable<(orbiter: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Remove the caller from the specified collator pool
       **/
      orbiterLeaveCollatorPool: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       ...
       **/
      orbiterUnregister: AugmentedSubmittable<(collatorsPoolCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
      /**
       * Remove a collator from orbiters program.
       **/
      removeCollator: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    openTechCommitteeCollective: {
       ...
       **/
      setMembers: AugmentedSubmittable<(newMembers: Vec<AccountId20> | (AccountId20 | string | Uint8Array)[], prime: Option<AccountId20> | null | Uint8Array | AccountId20 | string, oldCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<AccountId20>, Option<AccountId20>, u32]>;
      /**
    ...
    parachainStaking: {
       ...
       **/
      cancelDelegationRequest: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       ...
       **/
      delegate: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, candidateDelegationCount: u32 | AnyNumber | Uint8Array, delegationCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128, u32, u32]>;
      /**
       * If caller is not a delegator and not a collator, then join the set of delegators
       * If caller is a delegator, then makes delegation to change their delegation state
       * Sets the auto-compound config for the delegation
       **/
      delegateWithAutoCompound: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, autoCompound: Percent | AnyNumber | Uint8Array, candidateDelegationCount: u32 | AnyNumber | Uint8Array, candidateAutoCompoundingDelegationCount: u32 | AnyNumber | Uint8Array, delegationCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128, Percent, u32, u32, u32]>;
      /**
       * Bond more for delegators wrt a specific collator candidate.
       **/
      delegatorBondMore: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, more: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128]>;
      /**
       ...
       **/
      executeCandidateBondLess: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Execute pending request to change an existing delegation
       **/
      executeDelegationRequest: AugmentedSubmittable<(delegator: AccountId20 | string | Uint8Array, candidate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20]>;
      /**
       * Execute leave candidates request
       **/
      executeLeaveCandidates: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, candidateDelegationCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u32]>;
      /**
       * Force join the set of collator candidates.
       * It will skip the minimum required bond check.
       **/
      forceJoinCandidates: AugmentedSubmittable<(account: AccountId20 | string | Uint8Array, bond: u128 | AnyNumber | Uint8Array, candidateCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128, u32]>;
      /**
       ...
       **/
      hotfixRemoveDelegationRequestsExitedCandidates: AugmentedSubmittable<(candidates: Vec<AccountId20> | (AccountId20 | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Vec<AccountId20>]>;
      /**
       ...
       **/
      notifyInactiveCollator: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       ...
       **/
      scheduleDelegatorBondLess: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, less: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128]>;
      /**
       ...
       **/
      scheduleRevokeDelegation: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Sets the auto-compounding reward percentage for a delegation.
       **/
      setAutoCompound: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array, value: Percent | AnyNumber | Uint8Array, candidateAutoCompoundingDelegationCountHint: u32 | AnyNumber | Uint8Array, delegationCountHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Percent, u32, u32]>;
      /**
    ...
    readonly max: Perbill;
       ...
       **/
      setInflationDistributionConfig: AugmentedSubmittable<(updated: PalletParachainStakingInflationDistributionConfig) => SubmittableExtrinsic<ApiType>, [PalletParachainStakingInflationDistributionConfig]>;
      /**
       * Deprecated: please use `set_inflation_distribution_config` instead.
       * 
       * Set the account that will hold funds set aside for parachain bond
       **/
      setParachainBondAccount: AugmentedSubmittable<(updated: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
       * Deprecated: please use `set_inflation_distribution_config` instead.
       * 
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: MoonriverRuntimeRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | { PalletRandomness: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proxy: {
       ...
       * zero.
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonriverRuntimeProxyType, u32]>;
      /**
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      killPure: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonriverRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonriverRuntimeProxyType> | null | Uint8Array | MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonriverRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonriverRuntimeProxyType> | null | Uint8Array | MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<MoonriverRuntimeProxyType>, Call]>;
      /**
       ...
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonriverRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    referenda: {
       ...
       * Emits `Submitted`.
       **/
      submit: AugmentedSubmittable<(proposalOrigin: MoonriverRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { Origins: any } | { TreasuryCouncilCollective: any } | { OpenTechCommitteeCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | string | Uint8Array, proposal: FrameSupportPreimagesBounded | { Legacy: any } | { Inline: any } | { Lookup: any } | string | Uint8Array, enactmentMoment: FrameSupportScheduleDispatchTime | { At: any } | { After: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    treasury: {
       ...
       **/
      spend: AugmentedSubmittable<(assetKind: Null | null, amount: Compact<u128> | AnyNumber | Uint8Array, beneficiary: AccountId20 | string | Uint8Array, validFrom: Option<u32> | null | Uint8Array | u32 | AnyNumber) => SubmittableExtrinsic<ApiType>, [Null, Compact<u128>, AccountId20, Option<u32>]>;
      /**
       * Propose and approve a spend of treasury funds.
       * 
       * ## Dispatch Origin
       ...
       **/
      spendLocal: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array, beneficiary: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonriverRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { Origins: any } | { TreasuryCouncilCollective: any } | { OpenTechCommitteeCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    xcmTransactor: {
       ...
       **/
      deregister: AugmentedSubmittable<(index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u16]>;
      /**
       * Manage HRMP operations
       **/
      hrmpManage: AugmentedSubmittable<(action: PalletXcmTransactorHrmpOperation | { InitOpen: any } | { Accept: any } | { Close: any } | { Cancel: any } | string | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletXcmTransactorHrmpOperation, PalletXcmTransactorCurrencyPayment, PalletXcmTransactorTransactWeights]>;
      /**
       ...
       **/
      register: AugmentedSubmittable<(who: AccountId20 | string | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u16]>;
      /**
       * Remove the fee per second of an asset on its reserve chain
       **/
      removeFeePerSecond: AugmentedSubmittable<(assetLocation: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation]>;
      /**
       * Remove the transact info of a location
       **/
      removeTransactInfo: AugmentedSubmittable<(location: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation]>;
      /**
       * Set the fee per second of an asset on its reserve chain
       **/
      setFeePerSecond: AugmentedSubmittable<(assetLocation: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array, feePerSecond: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, u128]>;
      /**
       * Change the transact info of a location
       **/
      setTransactInfo: AugmentedSubmittable<(location: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array, transactExtraWeight: SpWeightsWeightV2Weight | { refTime?: any; proofSize?: any } | string | Uint8Array, maxWeight: SpWeightsWeightV2Weight | { refTime?: any; proofSize?: any } | string | Uint8Array, transactExtraWeightSigned: Option<SpWeightsWeightV2Weight> | null | Uint8Array | SpWeightsWeightV2Weight | { refTime?: any; proofSize?: any } | string) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, SpWeightsWeightV2Weight, SpWeightsWeightV2Weight, Option<SpWeightsWeightV2Weight>]>;
      /**
       ...
       **/
      transactThroughDerivative: AugmentedSubmittable<(dest: MoonriverRuntimeXcmConfigTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, innerCall: Bytes | string | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array, refund: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeXcmConfigTransactors, u16, PalletXcmTransactorCurrencyPayment, Bytes, PalletXcmTransactorTransactWeights, bool]>;
      /**
       ...
       **/
      transactThroughSigned: AugmentedSubmittable<(dest: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, call: Bytes | string | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array, refund: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, PalletXcmTransactorCurrencyPayment, Bytes, PalletXcmTransactorTransactWeights, bool]>;
      /**
       ...
       **/
      transactThroughSovereign: AugmentedSubmittable<(dest: XcmVersionedLocation | { V2: any } | { V3: any } | { V4: any } | string | Uint8Array, feePayer: Option<AccountId20> | null | Uint8Array | AccountId20 | string, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, call: Bytes | string | Uint8Array, originKind: XcmV3OriginKind | 'Native' | 'SovereignAccount' | 'Superuser' | 'Xcm' | number | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array, refund: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedLocation, Option<AccountId20>, PalletXcmTransactorCurrencyPayment, Bytes, XcmV3OriginKind, PalletXcmTransactorTransactWeights, bool]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    xcmWeightTrader: {
      addAsset: AugmentedSubmittable<(location: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array, relativePrice: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingXcmV4Location, u128]>;
      editAsset: AugmentedSubmittable<(location: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array, relativePrice: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingXcmV4Location, u128]>;
      pauseAssetSupport: AugmentedSubmittable<(location: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingXcmV4Location]>;
      removeAsset: AugmentedSubmittable<(location: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingXcmV4Location]>;
      resumeAssetSupport: AugmentedSubmittable<(location: StagingXcmV4Location | { parents?: any; interior?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingXcmV4Location]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
