...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetIdType: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<MoonriverRuntimeXcmConfigAssetType>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Reverse mapping of AssetIdType. Mapping from an asset type to an asset id.
       * This is mostly used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetTypeId: AugmentedQuery<ApiType, (arg: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonriverRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonriverRuntimeXcmConfigAssetType]>;
      /**
       * Generic query
       **/
