...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetIdType: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<MoonbaseRuntimeXcmConfigAssetType>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Reverse mapping of AssetIdType. Mapping from an asset type to an asset id.
       * This is mostly used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetTypeId: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonbaseRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonbaseRuntimeXcmConfigAssetType]>;
      /**
       * Generic query
       **/
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeRuntimeParamsRuntimeParametersKey | { RuntimeConfig: any } | { PalletRandomness: any } | string | Uint8Array) => Observable<Option<MoonbaseRuntimeRuntimeParamsRuntimeParametersValue>>, [MoonbaseRuntimeRuntimeParamsRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [MoonbaseRuntimeRuntimeParamsRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
