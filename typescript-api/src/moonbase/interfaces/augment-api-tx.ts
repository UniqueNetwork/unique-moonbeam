...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * assetType
       **/
      changeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, MoonbaseRuntimeXcmConfigAssetType, u32]>;
      /**
       ...
       **/
      registerForeignAsset: AugmentedSubmittable<(asset: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonbaseRuntimeAssetConfigAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array, isSufficient: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeXcmConfigAssetType, MoonbaseRuntimeAssetConfigAssetRegistrarMetadata, u128, bool]>;
      /**
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: MoonbaseRuntimeRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | { PalletRandomness: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    proxy: {
       ...
       * zero.
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u32]>;
      /**
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeProxyType, u32, u16]>;
      /**
       ...
       **/
      killPure: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbaseRuntimeProxyType> | null | Uint8Array | MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbaseRuntimeProxyType>, Call]>;
      /**
       ...
       * - `call`: The call to be made by the `real` account.
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbaseRuntimeProxyType> | null | Uint8Array | MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<MoonbaseRuntimeProxyType>, Call]>;
      /**
       ...
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    referenda: {
       ...
       * Emits `Submitted`.
       **/
      submit: AugmentedSubmittable<(proposalOrigin: MoonbaseRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | { TreasuryCouncilCollective: any } | { Origins: any } | { OpenTechCommitteeCollective: any } | string | Uint8Array, proposal: FrameSupportPreimagesBounded | { Legacy: any } | { Inline: any } | { Lookup: any } | string | Uint8Array, enactmentMoment: FrameSupportScheduleDispatchTime | { At: any } | { After: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * - O(1).
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonbaseRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | { TreasuryCouncilCollective: any } | { Origins: any } | { OpenTechCommitteeCollective: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
